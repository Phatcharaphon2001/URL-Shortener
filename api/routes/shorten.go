...
import (
	...
	"github.com/Phatcharaphon2001/URL-Shortener/database"
	"github.com/Phatcharaphon2001/URL-Shortener/helpers"
...
func ShortenURL(c *fiber.Ctx) error {
	...
	if val != "" {
		return c.Status(fiber.StatusServiceUnavailable).JSON(fiber.Map{"error": "URL custom short is already in use"})
	}
	if body.Expiry == 0 {
		body.Expiry = 24
	}
